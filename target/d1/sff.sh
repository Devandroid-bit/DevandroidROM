...
# SEC Floating Feature configuration file for Galaxy Note10 (d1)
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMN970F
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_davinci1_exynos9820
