...
# SEC Floating Feature configuration file for Galaxy Note10+ (d2s)
...
# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy Note10+
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 10 V; 4.5 A
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMN975F
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_davinci2_exynos9820
