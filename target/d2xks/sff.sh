...
# SEC Floating Feature configuration file for Galaxy Note10+ 5G (d2xks)
...
SEC_FLOATING_FEATURE_LCD_CONFIG_DEFAULT_SCREEN_MODE=3
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=face,pos:0.5:0.0223,size:0.1018:0.0482,type:circle
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_SUBDISPLAY_POLICY=

# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy Note10+ 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 10 V; 4.5 A
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMN976N
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_davinci2x_exynos9820
SEC_FLOATING_FEATURE_SYSTEMUI_CONFIG_CORNER_ROUND=3.3
...
# Graphics
SEC_FLOATING_FEATURE_GRAPHICS_CONFIG_GAME_DEFAULT_FRAMERATE=60

# Smart manager
SEC_FLOATING_FEATURE_SMARTMANAGER_CONFIG_PACKAGE_NAME=com.samsung.android.lool
