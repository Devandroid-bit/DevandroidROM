...
# SEC Floating Feature configuration file for Galaxy Note10 5G (d1xks)
...
SEC_FLOATING_FEATURE_BIXBYVISION_CONFIG_3DSCANNER=
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMN971N
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_davinci1x_exynos9820
SEC_FLOATING_FEATURE_SYSTEMUI_CONFIG_CORNER_ROUND=3.5
